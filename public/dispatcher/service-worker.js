...
// -- the dispatcher dashboard isn't an installable PWA like the crew MDT,
// so there's no app-shell caching here, just the push/notificationclick
...
self.addEventListener('notificationclick', (event) => {
  ...
  const url = event.notification.data?.url || '/dispatcher/';
  event.waitUntil(
